...
namespace ConfigCadAutoruns
{
    public class IniHelper
    {
        ...
        public static int ReadInt(string section, string key, int def, string filePath)
        {
            try
            {
                return int.Parse(ReadString(section, key, def.ToString(), filePath));
            }
            catch
            {
            }
        ...
        public static float ReadFloat(string section, string key, float def, string filePath)
        {
            try
            {
                var sval = ReadString(section, key, "##", filePath);
                if (sval == "##")
                    return def;
